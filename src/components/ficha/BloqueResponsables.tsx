...
export function BloqueResponsables({ paciente }: { paciente: Paciente }) {
  ...
  return (
    <section aria-labelledby="titulo-responsables" className="bg-card px-4 py-3">
      <h2
      ...
      {fueraDeDupla && (
        <p
          role="status"
          className="mt-3 flex items-start gap-2 rounded-md border-l-[3px] border-l-clinico-ambar bg-muted/40 px-3 py-2 text-base font-semibold text-foreground"
        >
